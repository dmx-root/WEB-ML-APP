...
import { NavListDespGroup } from './NavListDespGroup'
...
export function NavComponent(){
    ...
    // 6	Administrar perfíl
    // 7	Cuentas

    // 8	Items

    // 9	Administrar Operarios
    // 10	Administrar OCR
    // 11	Administrar OP
    // 12	Administrar Módulos

    // 13	Analíticas OCR
    // 14	Analíticas OP
    // 15	Modulos

    // 16	Administrar modulos
    // 17	Asignación de modulos

    // 18	Eficiencia

    // 19	Cerrar sesión

    // 20	Codigos De Barras
    // 21	Colores
    // 22	Modulos
    // 23	Talla
    return(
        <div className="nav-component-container">
            ...
            <div className="item-list-container">
                <ol id='ol-list-item-nav'>
                    <MenuItemGroup title={'Cuenta'}>
                        <NavItem label={'Cerrar sesión'}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> */}
                        </NavItem>
                        <NavItem label={'Administrar perfíl'}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sliders"><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="1" y1="14" x2="7" y2="14"></line><line x1="9" y1="8" x2="15" y2="8"></line><line x1="17" y1="16" x2="23" y2="16"></line></svg>
                        </NavItem>
                    </MenuItemGroup>
                    <MenuItemGroup title={'Administarción'}>
                        <NavItem label={'Cuentas'}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                        </NavItem>
                        <NavListDespGroup>
                            <NavItem label={'Items-1'}/>
                            <NavItem label={'Items-2'}/>
                                <NavListDespGroup>
                                    <NavItem label={'Items-A'}/>
                                    <NavItem label={'Items-B'}/>
                            </NavListDespGroup>
                            <NavItem label={'Items-3'}/>
                        </NavListDespGroup>
                        <NavItem label={'Items'}>
